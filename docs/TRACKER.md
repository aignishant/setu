...
> **Plan v2.4.0.** A day counts as *written* only when it has a hub **and** a non-empty `parts/` directory (Principle 16 · plan Part 11). Folders are named for their subject — `days/day-NN-<slug>/parts/NN-<slug>/` — so this table and the file tree read the same way. v2.4.0 sizes a day to one ordinary sitting - three to five parts, with the ceilings in plan Part 11.7 - and every part ends in the code you write (Principles 21 and 22).

## Progress

| | Count | Of total |
|---|---|---|
| 📄 Days written in the v2.4.0 shape | **33** | 13.7% |
| 📚 Sub-topic documents in `parts/` | **578** | — |
...
| 4 | M4 | Pandas 3.0 (Module 4) | 26–35 | 7/10 | 149 | 0/10 |
