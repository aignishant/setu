...
> **Plan v2.3.0.** A day counts as *written* only when it has a hub **and** a non-empty `parts/` directory (Principle 16 · plan Part 11). Folders are named for their subject — `days/day-NN-<slug>/parts/NN-<slug>/` — so this table and the file tree read the same way. v2.3.0 retired the `papers/` directory: a source is cited inline, in the part that needs it, and the words themselves are now part of the contract (Principle 20).

## Progress

| | Count | Of total |
|---|---|---|
| 📄 Days written in the v2.3.0 shape | **33** | 13.7% |
| 📚 Sub-topic documents in `parts/` | **590** | — |
| ✅ Days completed (checklist fully ticked) | **4** | 1.7% |
| ⬜ Still to write | **208** | 86.3% |
...
| 4 | M4 | Pandas 3.0 (Module 4) | 26–35 | 7/10 | 155 | 0/10 |
| 5 | M5 | Visualisation (Module 5) | 36–41 | 0/6 | 6 | 0/6 |
| 6 | M6 | SQL & NoSQL (Module 6) | 42–51 | 0/10 | 0 | 0/10 |
| 7 | M7 | Streamlit (Module 7) | 52–57 | 0/6 | 0 | 0/6 |
| 8 | M8 | Statistics foundations (Module 8) | 58–68 | 0/11 | 0 | 0/11 |
| 9 | M9 | Inferential statistics (Module 9) | 69–75 | 0/7 | 0 | 0/7 |
| 10 | M10 | Feature engineering (Module 10) | 76–83 | 0/8 | 0 | 0/8 |
| 11 | M11 | EDA (Module 11) | 84–90 | 0/7 | 0 | 0/7 |
| 12 | M12 | Machine learning fundamentals (Module 12) | 91–106 | 0/16 | 0 | 0/16 |
| 13 | M13 | Ensembles & clustering (Module 13) | 107–116 | 0/10 | 0 | 0/10 |
| 14 | M14 | Classical NLP (Module 14) | 117–124 | 0/8 | 0 | 0/8 |
| 15 | M15 | Deep learning foundations (Module 15) | 125–137 | 0/13 | 0 | 0/13 |
| 16 | M16 | Sequence models & transformers (Module 16) | 138–149 | 0/12 | 0 | 0/12 |
| 17 | M17 | Generative AI foundations (Module 17) | 150–154 | 0/5 | 0 | 0/5 |
| 18 | M18 | Vector databases (Module 18) | 155–161 | 0/7 | 0 | 0/7 |
| 19 | M19 | RAG (Module 19) | 162–171 | 0/10 | 0 | 0/10 |
| 20 | M20 | LangChain (Module 20) | 172–181 | 0/10 | 0 | 0/10 |
| 21 | M21 | Agentic AI concepts (Module 21) | 182–184 | 0/3 | 0 | 0/3 |
| 22 | M22 | LangGraph fundamentals (Module 22) | 185–191 | 0/7 | 0 | 0/7 |
| 23 | M23 | State & memory (Module 23) | 192–196 | 0/5 | 0 | 0/5 |
| 24 | M24 | HITL & UX (Module 24) | 197–201 | 0/5 | 0 | 0/5 |
| 25 | M25 | Agentic RAG (Module 25) | 202–208 | 0/7 | 0 | 0/7 |
| 26 | M26 | Model Context Protocol (Module 26) | 209–215 | 0/7 | 0 | 0/7 |
| 27 | M27 | Multi-agent systems (Module 27) | 216–224 | 0/9 | 0 | 0/9 |
| 28 | — | 🏁 Capstone — Project Setu | 225–238 | 0/14 | 0 | 0/14 |
| 29 | — | Portfolio & handoff | 239–240 | 0/2 | 0 | 0/2 |
...
| Day | Title | IDs | Kind | Status | Parts | Open boxes |
|---|---|---|---|---|---|---|
| 20 | `ndarray`, dtypes, and array creation (NumPy 2.x names) | NP-01, NP-02 | lab | 📄 written | 20 | 132 |
| 21 | Indexing, slicing, boolean masks — and the view trap | NP-03 | lab | 📄 written | 23 | 102 |
| 22 | Broadcasting and array manipulation | NP-04, NP-05 | lab | 📄 written | 22 | 113 |
| 23 | Universal functions, statistics, and `argsort` top-k | NP-06, NP-07 | lab | 📄 written | 26 | 108 |
| 24 | Binary/string functions and linear algebra | NP-08, NP-09 | lab | 📄 written | 24 | 120 |
| 25 | Copy vs view — and a vectorised stats module | NP-10 | gate | 📄 written | 19 | 84 |
...
| 30 | Missing data — and why the imputer lives in the pipeline | PD-07 | lab | 📄 written | 22 | 88 |
| 31 | `groupby`: split–apply–combine, `agg` and `transform` | PD-08 | lab | 📄 written | 20 | 90 |
| 32 | Merge, join, concat, pivot, melt | PD-09, PD-10 | lab | 📄 written | 19 | 96 |
| 33 | The `.str` and `.dt` accessors; resampling | PD-11, PD-12 | lab | ⬜ pending | 3 | — |
| 34 | Categorical dtype and `describe()` as a data-quality report | PD-13, PD-14 | lab | ⬜ pending | 3 | — |
...
| Day | Title | IDs | Kind | Status | Parts | Open boxes |
|---|---|---|---|---|---|---|
| 36 | Matplotlib — figure, axes, and the object API | VIZ-01 | lab | ⬜ pending | 3 | — |
| 37 | Customising charts; choosing the right chart type | VIZ-02, VIZ-03 | lab | ⬜ pending | 1 | — |
| 38 | Seaborn — statistical plots and faceting | VIZ-04 | lab | ⬜ pending | 2 | — |
...
| 106 | Hyperparameter search — grid, random, Optuna — ADR-007 | ML-17 | gate | ⬜ pending | — | — |
