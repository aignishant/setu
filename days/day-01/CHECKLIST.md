...
> [Day 0, 3.3](../day-00-setup/parts/03/3.3-the-done-gate.md).
>
...
- [ ] Read [1.1 — semantic versioning](parts/01/1.1-semantic-versioning.md), ran its check-yourself, answered its out-loud question
- [ ] Read [1.2 — version specifiers](parts/01/1.2-version-specifiers.md), ran its check-yourself, answered its out-loud question
- [ ] Read [1.3 — the resolution problem](parts/01/1.3-the-resolution-problem.md), ran its check-yourself, answered its out-loud question
...
- [ ] Read [2.1 — PyPI's JSON API](parts/02/2.1-the-pypi-json-api.md), ran its check-yourself, answered its out-loud question
- [ ] Read [2.2 — yanked and pre-release](parts/02/2.2-yanked-and-prerelease.md), ran its check-yourself, answered its out-loud question
- [ ] Read [2.3 — the check-pins script](parts/02/2.3-the-check-pins-script.md), ran its check-yourself, answered its out-loud question
...
- [ ] Read [3.1 — the Python-version intersection](parts/03/3.1-the-python-version-intersection.md), ran its check-yourself, answered its out-loud question
- [ ] Read [3.2 — freezing into pyproject and the lock](parts/03/3.2-freezing-into-pyproject-and-the-lock.md), ran its check-yourself, answered its out-loud question
- [ ] Read [3.3 — regenerating pins from evidence](parts/03/3.3-regenerating-pins-from-evidence.md), ran its check-yourself, answered its out-loud question
...
- [ ] Read [4.1 — the three breaking changes](parts/04/4.1-the-three-breaking-changes.md), ran its check-yourself, answered its out-loud question
- [ ] Read [4.2 — drift and the amendment protocol](parts/04/4.2-drift-and-the-amendment-protocol.md), ran its check-yourself, answered its out-loud question
