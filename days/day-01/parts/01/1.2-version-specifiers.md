...
[Day 0's `requires-python`](../../../day-00-setup/parts/02/2.4-uv-init-pyproject-and-the-lockfile.md)
...
([Day 0, 2.4](../../../day-00-setup/parts/02/2.4-uv-init-pyproject-and-the-lockfile.md)). This
...
- **`docs/PINS_DS.md` is a table of exact pins.** [3.3](../03/3.3-regenerating-pins-from-evidence.md)
...
- `\"specifier\"` — the double quotes inside the f-string are escaped because the whole script is
  ...
  it is one more reason real code goes in a file ([2.3](../02/2.3-the-check-pins-script.md)).
...
- `tomllib` — TOML parsing **in the standard library** since Python 3.11. No dependency needed to
  read `pyproject.toml`, which matters for [2.3](../02/2.3-the-check-pins-script.md): the tooling you
...
- `| head -5` — the pipe from [Day 0, 1.2](../../../day-00-setup/parts/01/1.2-git-and-git-bash.md),
  trimming the output.
