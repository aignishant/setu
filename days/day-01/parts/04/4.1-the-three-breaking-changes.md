...
prev: "../03/3.3-regenerating-pins-from-evidence.md"
...
[1.1](../01/1.1-semantic-versioning.md) established what a major bump *promises*: behaviour was
...
- `importlib.metadata.version(pkg)` — the installed version, as evidence rather than as intent
  ([1.1](../01/1.1-semantic-versioning.md)). None of these three are installed today, because packages
...
[1.1](../01/1.1-semantic-versioning.md)'s note, applied to a specific class of change.
