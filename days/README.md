...
**Looking for where something was taught?** [`INDEX.md`](INDEX.md) — every written part, one row
each, with its level and the curriculum IDs it serves. Generated by `./m tracker`; never edited by
hand.
