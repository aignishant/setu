...
> **The source.** Python does not use semantic versioning. What every Python resolver actually
> obeys is *PEP 440 — Version Identification and Dependency Specification* (2013),
