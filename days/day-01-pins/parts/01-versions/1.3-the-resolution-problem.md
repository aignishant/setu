...
next: "../02-pypi-index/2.1-the-pypi-json-api.md"
---
...
([Day 0, 1.1](../../../day-00-setup/parts/01-toolchain/1.1-why-one-tool-owns-the-environment.md)) and one
...
([Day 0, 2.4](../../../day-00-setup/parts/02-skeleton/2.4-uv-init-pyproject-and-the-lockfile.md)). You can
...
[3.1](../03-freezing/3.1-the-python-version-intersection.md).
...
- **[3.1](../03-freezing/3.1-the-python-version-intersection.md) computes the Python floor and ceiling** by
...
- `printf '...\n...\n'` — two contradictory requirements, one per line. `printf` interprets `\n`
  reliably where `echo` does not ([Day 0, 3.3](../../../day-00-setup/parts/03-m-script/3.3-the-done-gate.md)).
...
admits NumPy 2 (check the index — [2.1](../02-pypi-index/2.1-the-pypi-json-api.md)); drop the package and use
...
[Day 0, 1.4](../../../day-00-setup/parts/01-toolchain/1.4-python-3-12-under-uv.md), enforced by the resolver
rather than discovered at import time. This is the failure mode
[3.1](../03-freezing/3.1-the-python-version-intersection.md) exists to prevent before it happens.
...
([Day 0, 2.4](../../../day-00-setup/parts/02-skeleton/2.4-uv-init-pyproject-and-the-lockfile.md)). Resolve on a
...
**Next:** [2.1 — PyPI's JSON API, and why you never take a version from a tutorial](../02-pypi-index/2.1-the-pypi-json-api.md)
