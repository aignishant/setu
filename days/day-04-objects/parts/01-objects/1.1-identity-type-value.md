...
There is one shopping list stuck to the fridge. Two people live in the house.

On Monday, Priya says to her flatmate, "the list is on the fridge." Her flatmate walks over, picks up
that piece of paper and writes *milk* at the bottom. Later Priya looks at the fridge and sees milk.
She did not write it. It is there anyway, because there was only ever one piece of paper and both of
them were talking about it.

On Tuesday, Priya does something slightly different. She copies the list onto a fresh sheet, puts the
fresh sheet in her bag, and writes *milk* on her own sheet at the shop. That evening she checks the
fridge. The fridge list has no milk on it. Of course it does not. There are two pieces of paper now,
and she wrote on the other one.

Nothing about the words changed between Monday and Tuesday. Both days someone said "the list" and
both days someone wrote *milk*. What changed is whether there was **one piece of paper with two
people looking at it, or two pieces of paper**.

That is the whole of today. Python does exactly this, and it does nothing cleverer. When you write
`b = a`, Python does not copy anything onto a fresh sheet — it simply lets a second name mean the
same thing the first name meant. Whether writing through one name shows up under the other depends
on one question and one question only: **did you write on the paper, or did you swap in a new one?**

Telling those two apart is what the next twelve documents are for, and it starts with knowing what a
piece of paper is — which in Python is called an object.
