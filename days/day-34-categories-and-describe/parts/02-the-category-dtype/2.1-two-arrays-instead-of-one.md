...
- `astype("category")` — the conversion, spelled as a dtype name in a string. It returns a **new**
  ...
  ([Day 26, 3.1](../../../day-26-frames-and-copy-on-write/parts/03-copy-on-write/3.1-one-rule-instead-of-four.md)).
...
big = pd.Series(rng.choice(["bakery", "dairy", "dry goods"], 240_000), dtype="str").astype("category")
